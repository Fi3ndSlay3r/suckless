...
static const char *fonts[]          = { "MesloLGS NF:size=12", "fontawesome:size=12" };
...
static const char *setscreens[] = { "/home/ap/dev/dotfiles/i3/shs/screens.sh", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_p,  spawn,          { .v = setscreens } },
